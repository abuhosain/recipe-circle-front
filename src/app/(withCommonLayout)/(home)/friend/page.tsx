...
const FriendPages = () => {
  ...
  const UserCard = ({ user, isFollowing }: { user: User; isFollowing: boolean }) => (
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="relative">
            <img
              src={user.profilePicture || '/placeholder.svg?height=48&width=48&query=user avatar'}
              alt={user.name}
    ...
    <div className="min-h-screen p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Discover and follow interesting people in your network</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="p-6">
            {activeTab === 'following' ? (
              <div>
                <div className="mb-4">
                  <h2 className="text-lg font-semibold text-gray-900 mb-1">People You Follow</h2>
                  <p className="text-sm text-gray-600">Manage your connections and see who you're following</p>
                </div>
                ...
                {followingUsers.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 mb-4">Start following people to see them here</p>
                    <button
                      onClick={() => setActiveTab('discover')}
              ...
              <div>
                <div className="mb-4">
                  <h2 className="text-lg font-semibold text-gray-900 mb-1">Discover New People</h2>
                  <p className="text-sm text-gray-600">Find interesting people to connect with</p>
                </div>
                
                {nonFollowingUsers.length > 0 ? (
                  <div className="space-y-3">
                    {nonFollowingUsers.map((user) => (
                      <UserCard key={user._id} user={user} isFollowing={false} />
                    ))}
                  </div>
                ) : (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">You're following everyone available right now</p>
                  </div>
                )}
              </div>
            )}
